  ...
  return (
    <div className='m-auto w-11/12 flex justify-center md:min-w-full '>
      <div className='mt-14  flex flex-col justify-center items-center ' style={{ width: '100%' }}>
        ...
        <label className="input input-bordered flex border-rose-950 bg-white items-center gap-2m m-3 w-80 sm:w-96 md:w-5/12 md:h-16">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill='brown' className="addproduct-svg w-4 h-4 opacity-70"><path d="M40 48C26.7 48 16 58.7 16 72v48c0 13.3 10.7 24 24 24H88c13.3 0 24-10.7 24-24V72c0-13.3-10.7-24-24-24H40zM192 64c-17.7 0-32 14.3-32 32s14.3 32 32 32H480c17.7 0 32-14.3 32-32s-14.3-32-32-32H192zm0 160c-17.7 0-32 14.3-32 32s14.3 32 32 32H480c17.7 0 32-14.3 32-32s-14.3-32-32-32H192zm0 160c-17.7 0-32 14.3-32 32s14.3 32 32 32H480c17.7 0 32-14.3 32-32s-14.3-32-32-32H192zM16 232v48c0 13.3 10.7 24 24 24H88c13.3 0 24-10.7 24-24V232c0-13.3-10.7-24-24-24H40c-13.3 0-24 10.7-24 24zM40 368c-13.3 0-24 10.7-24 24v48c0 13.3 10.7 24 24 24H88c13.3 0 24-10.7 24-24V392c0-13.3-10.7-24-24-24H40z" /></svg>
          <input type="text" className="grow" value={type} placeholder="type" onChange={e => setType(e.target.value)} />
        </label>
        <label className="input input-bordered flex border-rose-950 bg-white items-center gap-2 m-3  w-80 sm:w-96 md:w-5/12 md:h-16">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" fill='brown' className="addproduct-svg w-4 h-4 opacity-70"><path d="M0 64C0 46.3 14.3 32 32 32H96h16H288c17.7 0 32 14.3 32 32s-14.3 32-32 32H231.8c9.6 14.4 16.7 30.6 20.7 48H288c17.7 0 32 14.3 32 32s-14.3 32-32 32H252.4c-13.2 58.3-61.9 103.2-122.2 110.9L274.6 422c14.4 10.3 17.7 30.3 7.4 44.6s-30.3 17.7-44.6 7.4L13.4 314C2.1 306-2.7 291.5 1.5 278.2S18.1 256 32 256h80c32.8 0 61-19.7 73.3-48H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H185.3C173 115.7 144.8 96 112 96H96 32C14.3 96 0 81.7 0 64z" /></svg>          <input type="number" className="grow" value={price} placeholder='Price' onChange={e => setPrice(e.target.value)} />
        </label>
        <label className="input input-bordered flex border-rose-950 bg-white items-center gap-2 m-3  w-80 sm:w-96 md:w-5/12 md:h-16">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" fill='brown' className="addproduct-svg w-4 h-4 opacity-70"><path d="M0 24C0 10.7 10.7 0 24 0H69.5c22 0 41.5 12.8 50.6 32h411c26.3 0 45.5 25 38.6 50.4l-41 152.3c-8.5 31.4-37 53.3-69.5 53.3H170.7l5.4 28.5c2.2 11.3 12.1 19.5 23.6 19.5H488c13.3 0 24 10.7 24 24s-10.7 24-24 24H199.7c-34.6 0-64.3-24.6-70.7-58.5L77.4 54.5c-.7-3.8-4-6.5-7.9-6.5H24C10.7 48 0 37.3 0 24zM128 464a48 48 0 1 1 96 0 48 48 0 1 1 -96 0zm336-48a48 48 0 1 1 0 96 48 48 0 1 1 0-96zM252 160c0 11 9 20 20 20h44v44c0 11 9 20 20 20s20-9 20-20V180h44c11 0 20-9 20-20s-9-20-20-20H356V96c0-11-9-20-20-20s-20 9-20 20v44H272c-11 0-20 9-20 20z" /></svg>          <input type="number" className="grow" value={stock} placeholder='Stock' onChange={e => setStock(e.target.value)} />
        </label>
